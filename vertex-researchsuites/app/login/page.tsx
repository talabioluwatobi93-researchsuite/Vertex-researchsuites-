    ...
    <div style={{background:"#ffffff",minHeight:"100vh",fontFamily:"Arial",padding:"20px"}}>
      <div style={{maxWidth:"400px",margin:"0 auto",paddingTop:"60px"}}>
        ...
        <div style={{background:"#f9f9f9",padding:"30px",borderRadius:"10px",border:"1px solid #eee"}}>
          ...
          <input placeholder="Enter your email" style={{width:"100%",padding:"12px",marginBottom:"20px",borderRadius:"5px",border:"1px solid #D4AF37",color:"#333333",boxSizing:"border-box"}} />
          <label style={{color:"#333333",fontWeight:"bold",display:"block",marginBottom:"5px"}}>Password</label>
          <input type="password" placeholder="Enter your password" style={{width:"100%",padding:"12px",marginBottom:"20px",borderRadius:"5px",border:"1px solid #D4AF37",color:"#333333",boxSizing:"border-box"}} />
          <button style={{width:"100%",padding:"12px",background:"#D4AF37",color:"#333333",fontWeight:"bold",border:"none",borderRadius:"5px",fontSize:"16px"}}>Login</button>
